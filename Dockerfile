...
RUN apk update \
	...
	&& make PREFIX=/usr -j4 'CFLAGS=-O2 -pipe -fno-strict-aliasing' 'LDFLAGS=-Wl,-O1 -Wl,--as-needed'  TARGET=linux-glibc USE_GETADDRINFO=1 USE_TFO=1 USE_THREAD=1 USE_LIBCRYPT=1 USE_NS=1 USE_PCRE2=1 USE_PCRE_JIT2=1 USE_OPENSSL=1  USE_ZLIB=1 \
